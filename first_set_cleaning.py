# California House Information 7 years ago
import pandas as pd
import requests
import time

# Retrieve data from csv
coordinate_based_data = pd.read_csv("California_House_Info.csv")
...
# Add a new column 'county' to store the county code
filtered_data.insert(filtered_data.columns.get_loc("latitude") + 1, "county", None)
